/** 
*	This module is the main Coraline manager, it does configure a SocketIO Server with certain config for being able to manage coraline connections
*	@module server
*	@requires socket.io
*	@requires ./coraline
*/
